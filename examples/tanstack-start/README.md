...
This example shows a host product that exposes TailorKit scopes, viewports, components,
...
- `src/components/tailorkit-shell.tsx` loads installed apps, publishes the root
  scope context with `useScope`, and renders the selected app in its viewport.
