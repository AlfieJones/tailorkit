    ...
    <HomeLayout {...baseOptions()}>
      <main className="min-h-screen bg-sidebar">
        <div className="mx-auto w-full max-w-7xl border-x border-border bg-background text-foreground">
          <section className="relative flex min-h-[900px] w-full overflow-hidden sm:min-h-[860px] md:min-h-[calc(100vh-6.5rem)]">
            <div className="relative z-10 flex min-h-[900px] w-full flex-col px-5 pt-8 sm:min-h-[860px] sm:px-10 md:min-h-[calc(100vh-6.5rem)] lg:px-16 lg:pt-10">
                ...
                <div className="max-w-[64rem] pt-6 sm:pt-8 lg:pt-10">
                  <h1 className="text-balance font-display text-[clamp(2.55rem,12.5vw,3.6rem)] font-bold leading-[0.94] tracking-tight text-foreground sm:text-[4.1rem] md:text-[4.55rem] lg:text-[4.9rem] xl:text-[4.95rem]">
                    ...
                    <span className="block">
                      ...
                      <LineShadowText className="whitespace-nowrap" shadowColor={shadowColor}>
                        with AI
                      </LineShadowText>
                    </span>
                  </h1>
...
function ChameleonDither({
  ...
  const targetColor = hueToHex(hue, isDark);
    ...
    <div className="pointer-events-none absolute -right-[34vw] bottom-16 z-0 aspect-[16/12] w-[112vw] origin-bottom-right opacity-35 mix-blend-multiply dark:mix-blend-screen sm:-right-[28vw] sm:bottom-12 sm:w-[86vw] sm:opacity-45 md:-right-[20vw] md:-bottom-6 md:w-[66vw] md:opacity-60 lg:-right-[13vw] lg:bottom-14 lg:w-[52vw] lg:opacity-100 xl:-right-[10vw] xl:bottom-0 xl:w-[48vw] 2xl:-right-[8vw] 2xl:-bottom-8">
      <div className="relative h-full w-full">
        <ImageDithering
          ...
          colorFront={isDark ? darkInkColor : "#111111"}
        ...
        {showCowboyHat ? (
          <ImageDithering
            ...
            colorBack={isDark ? "#000000" : "#ffffff"}
            colorFront={isDark ? "#d2a56f" : "#8a5524"}
            colorHighlight={isDark ? "#f0d0a3" : "#c47b32"}
            originalColors={false}
            inverted={true}
            type="8x8"
            size={1}
        ...
        {showMonocle ? (
          <ImageDithering
            ...
            colorBack={isDark ? "#000000" : "#ffffff"}
            colorFront={isDark ? "#d8d8d8" : "#111111"}
            colorHighlight={isDark ? "#f2f2f2" : "#111111"}
            originalColors={false}
            inverted={true}
            type="2x2"
            size={1.5}
...
function HeroFooter() {
  return (
    ...
    >
      ...
      <div className="relative h-16 overflow-hidden border-b border-border">
        ...
        <div className="absolute inset-x-0 top-3 space-y-2">
          <div className="h-px bg-border/80" />
          <div className="h-px bg-border/70" />
          <div className="h-px bg-border/60" />
          <div className="h-px bg-border/50" />
        </div>
        <div className="absolute inset-x-6 bottom-0 h-6 border-x border-border sm:inset-x-10 lg:inset-x-16" />
      </div>
    </div>
  );
}
